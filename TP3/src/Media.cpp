...
Media::Media(Auteur *auteur, Media::TypeMedia typeMedia) : nom_(""),
                                                           anneeDeSortie_(0),
                                                           genre_(Genre()),
                                                           pays_(Pays()),
                                                           estRestreintParAge_(false), auteur_(auteur),
...
Media::Media(const std::string &nom, unsigned int anneeDeSortie, Genre genre, Pays pays,
             bool estRestreintParAge, Auteur *auteur, Media::TypeMedia typeMedia) : nom_(nom),
...
Media::Media(const Media &serie) : nom_(serie.nom_),
